...
from main import Evolution, EvolutionIterator, MutationIterator, MutationList, find_evolution_fast, \
    find_evolution, \
...
@pytest.mark.parametrize("long_sequence, function", [
...
def test_benchmark(long_sequence, function):
    ...
    format_the_output(long_sequence, solution.mutations)
...
def test_very_long_sequence():
    long_sequence = list(range(1, 100))
